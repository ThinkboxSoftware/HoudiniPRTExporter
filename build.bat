@REM Copyright 2017 Thinkbox Software Inc.
@REM .
...
@REM This is a Windows build script to compile the PRT Exporter for Houdini 16.
...
@echo(
@echo WARNING: hcustom may have a bug where it will crash on exit, even upon
@echo successful compilation and installation.
@echo Check the log for compiler errors to see if compilation was unsuccessful.
