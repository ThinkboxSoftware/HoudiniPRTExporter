...
# 	This is an OS X build script to compile the PRT Exporter for Houdini 13.
...
hcustom -I $HOME/PRT-IO-Library -I $HFS/toolkit/include -I $HFS/toolkit/include/OpenEXR -l Half -l z exportPRT.cpp