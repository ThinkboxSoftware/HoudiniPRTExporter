...
# This is a Linux build script to compile the PRT Exporter for Houdini 16.
...
hcustom -I $HOME/PRT-IO-Library -I $HFS/toolkit/include -I $HFS/toolkit/include/OpenEXR -L $HFS/dsolib -L /usr/lib -l Half -l z exportPRT.cpp
